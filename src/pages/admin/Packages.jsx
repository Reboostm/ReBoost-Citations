...
import { Plus, Pencil, Trash2, Package, Check } from 'lucide-react'
...
function PackageForm({ pkg, onSubmit, loading }) {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      <Modal open={showAdd} onClose={() => setShowAdd(false)} title="Create Package" size="md">
        <PackageForm onSubmit={handleAdd} loading={saving} />
      </Modal>
      <Modal open={!!editing} onClose={() => setEditing(null)} title="Edit Package" size="md">
        {editing && <PackageForm pkg={editing} onSubmit={handleEdit} loading={saving} />}
      </Modal>
      <ConfirmDialog
        open={!!deleteTarget}
